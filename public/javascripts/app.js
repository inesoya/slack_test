$(function() {
            ...
            var slackWebhook = "https://hooks.slack.com/services/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";

            var slackChannel = "Eider Garcia";
                    ...
                    socket.on(currentUri, function(event, data) {
                            ...
                            try {
                                var payload = {
                                    ...
                                    "mrkdwn": true,
                                    "attachments": [{
                                        "text":  event.body.event."com.adobe.mcloud.pipeline.pipelineMessage"."com.adobe.mcloud.protocol.trigger"."enrichments"."analyticsHitSummary"."dimensions"."eVar140"."data",
